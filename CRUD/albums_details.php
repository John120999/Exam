...
function confirmEdit(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = `edit_albums.php?id=${id}`;
        }
    });
}
</script>
...
function confirmDelete(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = `delete_albums.php?id=${id}`;
        }
    });
}
</script>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            <li class="list-group-item"><strong>Album Name:</strong> <?= htmlspecialchars($artist['album']) ?></li>
                        ...
                        <a href="albums.php" class="btn btn-primary mt-3">← Back to Album List</a>
